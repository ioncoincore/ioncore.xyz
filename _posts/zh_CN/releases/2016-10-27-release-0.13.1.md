...
比特币核心安装二进制文件可从 ion.org 下载。源代码在比特币核心代码储存库里。

比特币核心 0.13.1 版本现可被下载：

<https://bitcoin.org/bin/ion-core-0.13.1/>
...
除此之外，随着 0.12.x 的发布，我们收到不同的报告，比特币核心在 Windows XP [not clear](https://github.com/cevap/ion/issues/7681#issuecomment-217439891) 
...
[Segwit FAQ]: https://ioncore.xyz/en/2016/01/26/segwit-benefits/
[segwit wallet developers guide]: https://ioncore.xyz/en/segwit_wallet_dev/
...
[versionbits FAQ]: https://ioncore.xyz/en/2016/06/08/version-bits-miners-faq/
...
- `ion-${VERSION}-arm-linux-gnueabihf.tar.gz: Linux binaries targeting the 32- bit ARMv7-A architecture.
Linux 二进制文件针对于 32 点位 ARMv7-A 架构。

- `ion-${VERSION}-aarch64-linux-gnu.tar.gz: Linux binaries targeting the 64-bit
