...
- [隔离见证：下一步](https://ioncore.org/en/2016/06/24/segwit-next-steps/) IonCore.org 博客文章
...
欲了解比特币核心0.13.0版本的所有变更详情，请 [阅读版本发布说明][release notes]. 如欲下载，请访问 [下载页面](https://ion.org/en/download) 或者 [文件目录](https://ion.org/bin/ion-core-0.13.0/).
