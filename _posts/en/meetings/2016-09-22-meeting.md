...
- Wumpus has started using a new feature on github for tracking longer-running [projects](https://github.com/cevap/ion/projects). 
...
In [last weeks meeting](/en/meetings/2016/09/15/#release) developers decided to drop PR [#8635][] (Enforce mandatory softfork flags for segwit block/tx) from the [0.13.1 milestone](https://github.com/cevap/ion/milestone/22) tag.
...
Sdaftuar thinks the [#8279](https://github.com/cevap/ion/issues/8279) issue (Mempool DoS risk in segwit due to malleated transactions) is sufficiently resolved for 0.13.1
...
- Remove PR [#8654][] and [#8757][] from the 0.13.1 milestones, as well as issue [#8279](https://github.com/cevap/ion/issues/8279)
...
[#8757]: https://github.com/cevap/ion/pull/8757
