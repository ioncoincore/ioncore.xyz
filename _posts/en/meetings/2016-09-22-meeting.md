...
- [Link to this week logs](https://botbot.me/freenode/ion-core-dev/2016-09-22/?msg=73443433&page=4)
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/ion-core-dev/2016/ion-core-dev.2016-09-22-18.59.html)
 
---
 
## Notes / short topics

- Wumpus has started using a new feature on github for tracking longer-running [projects](https://github.com/ion/ion/projects). 
...
In [last weeks meeting](/en/meetings/2016/09/15/#release) developers decided to drop PR [#8635][] (Enforce mandatory softfork flags for segwit block/tx) from the [0.13.1 milestone](https://github.com/ion/ion/milestone/22) tag.
...
Sdaftuar thinks the [#8279](https://github.com/ion/ion/issues/8279) issue (Mempool DoS risk in segwit due to malleated transactions) is sufficiently resolved for 0.13.1

[Iond](https://github.com/ionsuite/iond), the alternative ion implementation in Go, will finalize the segwit stuff soon. Petertodds [python ion library](https://github.com/petertodd/python-ionlib) has a good [PR for segwit](https://github.com/petertodd/python-ionlib/pull/112) too. Gmaxwell notes mining software has improved a lot lately on the segwit front. Achow101 notes armory is aiming to have full segwit support the release after the next one.

### meeting conclusion

- Remove PR [#8654][] and [#8757][] from the 0.13.1 milestones, as well as issue [#8279](https://github.com/ion/ion/issues/8279)
...
Earlier this month Gmaxwell [posted](https://lists.linuxfoundation.org/pipermail/ion-dev/2016-September/013104.html) on the mailinglist the desire to complete the retirement of the alert system, which has been well received.

### meeting comments

Gmaxwell proposed these next steps:

- Create a ioncore.org or ion.org announcement message.
...
[#8635]: https://github.com/ion/ion/pull/8635
[#8634]: https://github.com/ion/ion/pull/8634
[#8499]: https://github.com/ion/ion/pull/8499
[#8526]: https://github.com/ion/ion/pull/8526
[#8393]: https://github.com/ion/ion/pull/8393
[#8757]: https://github.com/ion/ion/pull/8757
