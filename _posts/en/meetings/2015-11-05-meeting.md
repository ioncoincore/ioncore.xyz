...
Check to see if there are any other commits for the 0.11.2 RC. As soon as [6948](https://github.com/ion/ion/pull/6948) and [6825](https://github.com/ion/ion/pull/6825) are merged it seems good to go.  
...
0.11.2 RC1 has been released as of today: https://ion.org/bin/ion-core-0.11.2/test/
...
Because of time-constrains [opt-in replace-by-fee](https://github.com/ion/ion/pull/6871) has been deferred to next weeks meeting, but most people seem to want it in 0.12. sdaftuar makes a note that we need to make clear to users what they need to do if they don't want to accept opt-in transactions.  
...
Everybody likes to include [secp256k1](https://github.com/ion/ion/pull/6954) ASAP, as it has a very large performance increase.   
Some people would like to include the [sigcache pull-request](https://github.com/ion/ion/pull/6918), [BIP30](https://github.com/ion/ion/commit/a206b0ea12eb4606b93323268fc81a4f1f952531), [modifyNewCoins](https://github.com/ion/ion/pull/6932) and a [createNewBlock rewrite](https://github.com/ion/ion/pull/6898) if it's ready.   
Wumpus advises against merging last-minute performance improvements for 0.12.  

### meeting conclusion

Mentioned pull-requests should be reviewed, prioritizing [CreateNewBlock](https://github.com/ion/ion/pull/6898)  
...
There's a [pull-request](https://github.com/ion/ion/pull/6357) available that optimizes the current transaction priority, thereby avoiding the political debate that goes with changing the definition of transaction priority.  
Luke-jr thinks the old policy should remain possible.
 
### meeting conclusion

Check to see if [PR #6357](https://github.com/ion/ion/pull/6357) is safe and efficient enough.
...
Merge ["Policy: Lower default limits for tx chains"](https://github.com/ion/ion/pull/6771)  
