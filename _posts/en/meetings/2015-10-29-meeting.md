...
Check to see if there's anything that needs to be included in this release that's not already in. Luke-jr has a [Pull-request](https://github.com/ion/ion/pull/6825) open to add bugfixes.  
...
For review purposes iondrak combined both pull-requests ( https://github.com/ion/ion/compare/master...iondrak:sequenceandcsv )  
