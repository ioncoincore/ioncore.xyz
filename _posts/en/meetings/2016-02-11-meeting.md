...
[BIP68 implementation](https://github.com/cevap/ion/pull/7184) mempool-only    
...
Review/test BIP112 [#7524](https://github.com/cevap/ion/pull/7524) (rebased version)
...
A pull request usually exists of several different commits (changes to the code). These commits can be squashed together into a single commit. On the previous discussed BIP68 implementation some [discussion ensued](https://github.com/cevap/ion/pull/7184#issuecomment-182594295) on what to squash and what not.
