...
- [link to this week logs](http://ionstats.com/irc/ion-dev/logs/2015/12/17#l1450378915.0)  
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/ion-dev/2015/ion-dev.2015-12-17-19.01.html) 
...
There's a good [FAQ-ish post](https://np.reddit.com/r/Ion/comments/3urm8o/optin_rbf_is_misunderstood_ask_questions_about_it/) on reddit about it.
...
[#7219](https://github.com/cevap/ion/pull/7219) to make RBF policies optional (0 = never, 1 = always, 2 = opt-in) probably won't make it in 0.12.  
...
- Take a look at [#7062](https://github.com/cevap/ion/pull/7062) Fix mempool limiting and replace-by-fee for PrioritiseTransaction for 0.12  
- Take a look at [#7132](https://github.com/cevap/ion/pull/7132) Add option to opt into full-RBF when sending funds
...
Both the zero-cash and ion core team want automated testing of this stuff on many platforms, which can be done by buildbot.   
...
[meetingsource]: http://lists.linuxfoundation.org/pipermail/ion-discuss/2015-December/000039.html
