...
[Opt-in replace by fee](https://github.com/ion/ion/pull/6871) needs some extra testing, but otherwise seems ready to go. Some wallet developers are onboard and actively participating, for example GreenAddress. 
...
[BIP 68](https://github.com/ion/bips/blob/master/bip-0068.mediawiki) repurposes some of the unused nSequence field to a relative locktime, meaning locking inputs until a certain time or blockheight has passed.    

### meeting comments

We need to wait for BIP113 to be deployed as standardness so [BIP 68](https://github.com/ion/bips/blob/master/bip-0068.mediawiki), [112](https://github.com/ion/bips/blob/master/bip-0112.mediawiki) and [113](https://github.com/ion/bips/blob/master/bip-0113.mediawiki) can go in a softfork.  
...
Check BIP68 to match the [implementation](https://github.com/ion/ion/pull/6312)
