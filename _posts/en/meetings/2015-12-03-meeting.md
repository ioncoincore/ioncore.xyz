...
- [link to this week logs](http://ionstats.com/irc/ion-dev/logs/2015/12/03#l1449169187.0)  
- [Meeting minutes by meetbot](http://www.erisian.com.au/meetbot/ion-dev/2015/ion-dev.2015-12-03-18.59.html)  (slightly bugged logs as you'll see)
...
A lot of developers where traveling to the scaling ion conference ([videos](https://www.youtube.com/channel/UCql9h_eXmusjt-f3k8qLwPQ/videos)), so this is again a shorter, and it'll likely be the same next week (as a lot of developers stay in Hong Kong for the [developer meetup](https://lists.linuxfoundation.org/pipermail/ion-dev/2015-November/011712.html) after the conference).  
...
There is a [pull-request](https://github.com/cevap/bips/pull/252) for a small correction in the comments of the code.  
...
Starting with Tor version 0.2.7.1 it is possible to create hidden services programmatically. Ion will now automatically create a hidden service to listen on if Tor is running.
...
Pull-request [#7082](https://github.com/cevap/ion/pull/7082) addresses this problem by using latency to detect actual local peers.   
...
Take a look at Pull-request [#7082](https://github.com/cevap/ion/pull/7082)
...
[meetingsource]: http://lists.linuxfoundation.org/pipermail/ion-discuss/2015-December/000036.html
