...
- There's a queue of [PR's for 0.13.1](https://github.com/cevap/ion/milestones/0.13.1), review is encouraged.
...
Developers are now working on version 2 of compact blocks, which is almost identical to version 1, but supports segregated witness transactions. The changes to the BIP document are proposed [here](https://github.com/cevap/bips/pull/423)
...
- Create an issue about the problem ([done after the meeting](https://github.com/cevap/ion/issues/8692)).
...
[#8680]: https://github.com/cevap/ion/pull/8680
