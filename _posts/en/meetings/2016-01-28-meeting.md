...
ajtowns has written some functional test scripts for OP_CSV which will be helpful for testing [#7184](https://github.com/cevap/ion/pull/7184)([BIP 68](https://github.com/cevap/bips/blob/master/bip-0068.mediawiki)) and [#6564](https://github.com/cevap/ion/pull/6564)([BIP 112](https://github.com/cevap/bips/blob/master/bip-0112.mediawiki))
...
Review [#7091](https://github.com/cevap/ion/pull/7091), [#7287](https://github.com/cevap/ion/pull/7287), [#7310](https://github.com/cevap/ion/pull/7310) and [#7311](https://github.com/cevap/ion/pull/7311)
...
There's a release candidate 0.12rc2 available at https://bitcoin.org/bin/ion-core-0.12.0/test/

### meeting comments

We need to sign the win32 release with a new key for win7+ as the current key uses sha-1 which is broken.   
There's still some controversy how the changes for priority should be noted in the release notes. e.g. [#7346](https://github.com/cevap/ion/pull/7346)   
...
gmaxwell will change [#7082](https://github.com/cevap/ion/pull/7082) to only remove the privledging of localhost. The rest of the PR can be done for 12.1/0.13
...
[BIP70](https://github.com/cevap/bips/blob/master/bip-0070.mediawiki) (Payment Protocol) might be affected.   
The parts of core that still depend on openSSL are entropy, AES (wallet) and BIP70.   
There's a plan to replace openSSL for entropy with [fortuna](https://github.com/cevap/ion/pull/5885) (build by sipa and gmaxwell), which needs to be build into a separate library.  
