...
PR's [#7151](https://github.com/ion/ion/pull/7151) and [#7149](https://github.com/ion/ion/pull/7149) are mentioned to possibly still be included in 0.12 as well as a quick fix for [#7098](https://github.com/ion/ion/pull/7098) (to be written).  
...
PR [#7312](https://github.com/ion/ion/pull/7312) "Add RPC call abandontransaction" is proposed by Morcos to be a quick-fix to enable users to make their wallet forget about the inputs to a transaction that's not in the mempool. Better solutions should be build for 0.12.1  

### meeting conclusion  

Take a look at PR's [#7151](https://github.com/ion/ion/pull/7151), [#7149](https://github.com/ion/ion/pull/7149) and [#7312](https://github.com/ion/ion/pull/7312)  
Cfields will work on a fix for [#7098](https://github.com/ion/ion/pull/7098)  
...
- [BIP 9](https://github.com/ion/bips/blob/master/bip-0009.mediawiki) versionbits is moved back in priority a bit.  
