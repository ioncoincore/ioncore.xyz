...
[BIP 9](https://github.com/ion/bips/blob/master/bip-0009.mediawiki) Versionbits [PR #6816](https://github.com/ion/ion/pull/6816) is ready for implementation and needs more reviews.
...
To stop this from happening devs created a mechanism to reject and/or remove transactions from the mempool. This [mempool limiting](https://github.com/ion/ion/pull/6722) got merged this week.  
...
Testing shows there's a discrepancy between the configured mempool limit and the actual memory usage. This is caused by the amount of [UTXO](https://ion.org/en/glossary/unspent-transaction-output) data when processing transactions.   
...
Something TheBlueMatt [is working on](https://github.com/ion/ion/pull/6872)
...
jgarzik worked on a [patch for SQLite](https://github.com/ion/ion/pull/6873)  
...
CLTV stands for CheckLockTimeVerify, [BIP65](https://github.com/ion/ion/pull/6351) Commonly reffered to as: How you thought nLockTime worked before you actually tried to use it. 
...
review [BIP-113: Mempool-only median time-past as endpoint for lock-time calculations](https://github.com/ion/ion/pull/6566)
