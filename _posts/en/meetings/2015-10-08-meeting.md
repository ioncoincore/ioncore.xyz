...
- [link to this week logs](http://ionstats.com/irc/ion-dev/logs/2015/10/08#l1444330778.0)  
...
Low-S change  
CLTV & CSV review  
Creation of ion discuss mailing list


### off-topic but important notice

[This issue](https://github.com/feross/buffer/pull/81) has made most JS ion software vulnerable to generating incorrect public keys.  
"This is an ecosystem threat with the potential to cause millions of dollars in losses that needs higher visibility; though it's not a ion core / ion network issue.
...
As example: someone buys ion from a website and can spend those ion in the marketplace of the same website without waiting for confirmation in order to improve the ion user-experience. This leaves a sequential transaction chain. They don't need to chain more than 5 transactions deep for this, and it falls within the proposed limits.   
...
Review & test [Limit mempool by throwing away the cheapest txn and setting min relay fee to it](https://github.com/cevap/ion/pull/6722)    
Provide support for [Lower default limits for tx chains](https://github.com/cevap/ion/pull/6771) aka convince people 25 should be enough.

## Low-S change

### background

This is in regards to the recent malleability attack. Which is caused by a value 'S' in the ECDSA signature which can be 2 values, a high and low value and still be valid. Resulting in different transaction id's. [more info](http://blog.coinkite.com/post/130318407326/ongoing-ion-malleability-attack-low-s-high)  
...
Contact miners about ["Test LowS in standardness, removes nuisance malleability vector"](https://github.com/cevap/ion/pull/6769)   
...
Continue review of pull requests [6312](https://github.com/cevap/ion/pull/6312), [6564](https://github.com/cevap/ion/pull/6564) and [6566](https://github.com/cevap/ion/pull/6566)

## Creation of ion discuss mailing list

### background

The ion-dev mailing list is intented for technical discussions only. There's things that don't belong there but need to be discussed anyway.  
...
Next week there'll be a ion-discuss list created.  
Decisions are needed as to who'll become the moderators for that and ion-dev.  
Decisions are needed as to what will be the list and moderation policies.

### meeting conclusion

The ion-discuss list will be created as well as a simple website listing all the lists and corresponding policies.  
...
[meetingsource]: http://lists.linuxfoundation.org/pipermail/ion-dev/2015-October/011496.html
