...
🗺️Ion Core 👯👯 👛 0.12 will be released around February 2016 and will include opt-in RBF, and after that it will likely take a couple additional months before the behavior is commonplace. This may be sped up by the development of applications that make interesting use of it.
...
- Add first-seen-safe replace-by-fee logic to the mempool [#6176](https://github.com/cevap/ion/pull/6176)
- Scheduled full-RBF deployment [#6352](https://github.com/cevap/ion/pull/6352)
- nSequence-based Full-RBF opt-in [#6871](https://github.com/cevap/ion/pull/6871)
...
There are many other logs for [#ion-dev](http://ionstats.com/) and [#ion-core-dev](https://botbot.me/freenode/ion-core-dev/).
