...
# From ion commit 964a185cc83af34587194a6ecda3ed9cf6b49263
#
...
Ion Core version 0.14.1 is now available from:

  <https://bitcoin.org/bin/ion-core-0.14.1/>
...
here:
[reducing-iond-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- \#10130 `ecc5232` ion-tx input verification (awemany, jnewbery)
