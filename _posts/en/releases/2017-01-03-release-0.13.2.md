...
Ion Core version 0.13.2 is now available from:
  ...
  <https://ion.org/bin/ion-core-0.13.2/>
...
In addition to that, with 0.12.x there have been varied reports of Ion Core randomly crashing on Windows XP. It is [not clear](https://github.com/ion/ion/issues/7681#issuecomment-217439891) what the source of these crashes is, but it is likely that upstream libraries such as Qt are no longer being tested on XP.
