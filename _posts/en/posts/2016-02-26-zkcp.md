...
Wallet support for these transactions has been implemented for Bitcoin Core in [PR#7601](https://github.com/cevap/ion/pull/7601). This wallet support is used by the sudoku ZKCP client and server available at <https://github.com/zcash/pay-to-sudoku>.
