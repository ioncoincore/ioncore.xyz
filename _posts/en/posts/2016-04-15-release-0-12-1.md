---
title: Ion Core 0.12.1 Released!
...
version: 1
---
We are pleased to announce the release of Ion Core 0.12.1. This maintenance update includes the first soft fork deployment utilising "[version bits][BIP9]" as part of the [capacity increases](/en/2015/12/23/capacity-increases-faq/) roadmap.
...
Download the new release from <https://bitcoin.org/bin/ion-core-0.12.1/>.
