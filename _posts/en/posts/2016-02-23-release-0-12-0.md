...
Download from <https://ion.org/bin/ion-core-0.12.0/>.
...
[Weekly Meeting Summaries](https://ioncore.org/en/meetings/)

IRC Community:
Join the `#ion-dev` and `#ion-core-dev` channels on `irc.freenode.net`.

[Slack Community](https://ioncore.slack.com), sign up at [slack.ioncore.org](https://slack.ioncore.org).

Twitter:
Follow Ion Core updates at [@ioncoreorg](https://twitter.com/ioncoreorg)
