...
- [Segregated Witness: the next steps](https://ioncore.xyz/en/2016/06/24/segwit-next-steps/) ioncore.xyz blog post
...
- [BIP133: `feefilter`
  message](https://github.com/cevap/bips/blob/master/bip-0133.mediawiki)
...
For details on all the changes made in Ion Core 0.13.0, please [read the release notes][release notes].  To download, please visit the [download page](https://bitcoin.org/en/download) or the [files directory](https://bitcoin.org/bin/ion-core-0.13.0/)
